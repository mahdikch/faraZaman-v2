...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	private static final String SQL_CREATE_TABLE_TRACK = ""
		...
		+ TrackContentProvider.Schema.COL_ROLE + " text default 'supervisor'" // Role: "driver" or "supervisor"
		+ ")";
	 ...
	 * v18: add TBL_TRACK.COL_ROLE for driver/supervisor separation
	 *</pre>
	 */
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		case 17:
			db.execSQL("alter table " + TrackContentProvider.Schema.TBL_TRACK + " add column " + TrackContentProvider.Schema.COL_ROLE + " text default 'supervisor'");
		}
	}
