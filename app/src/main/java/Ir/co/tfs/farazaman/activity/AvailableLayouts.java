...
import Ir.co.tfs.farazaman.layout.DownloadCustomLayoutTask;
import Ir.co.tfs.farazaman.layout.GetStringResponseTask;
import Ir.co.tfs.farazaman.layout.URLValidatorTask;
import Ir.co.tfs.farazaman.util.CustomLayoutsUtils;
import Ir.co.tfs.farazaman.util.URLCreator;
...
public class AvailableLayouts extends Activity {
    ...
    private final static String TMP_SHARED_PREFERENCES_FILE = "Ir.co.tfs.farazaman.tmpspfile";
