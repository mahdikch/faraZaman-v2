...
import Ir.co.tfs.farazaman.view.DisplayTrackView;
			...
			dtv.post(new Runnable() {
				...
				public void run() {
					new AlertDialog.Builder(DisplayTrack.this)
						.setTitle(Ir.co.tfs.farazaman.R.string.prefs_displaytrack_osm)
						.setMessage(Ir.co.tfs.farazaman.R.string.prefs_displaytrack_osm_summary_ask)
						.setNegativeButton(android.R.string.no, null)
						.setPositiveButton(Ir.co.tfs.farazaman.R.string.displaytrack_map, new DialogInterface.OnClickListener() {
							@Override
